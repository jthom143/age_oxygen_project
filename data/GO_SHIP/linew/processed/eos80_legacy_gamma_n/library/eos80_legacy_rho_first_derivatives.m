function [rho_SP, rho_t] = eos80_legacy_rho_first_derivatives(SP,t,p)

% eos80_legacy_rho_first_derivatives             SP & t partial derivatives
%                                                        of density (EOS80)
%==========================================================================
%
% USAGE:  
%  [rho_SP, rho_t] = eos80_legacy_rho_first_derivatives(SP,t,p)
%
% DESCRIPTION:
%  Calculates the rho_first_derivatives.
%
...
%
% OUTPUT:
%  rho_SP  =  partial derivative of density           [ (kg/m^3)(g/kg)^-1 ]
%             with respect to practical Salinity
%  rho_t   =  partial derivative of density                  [ kg/(m^3 K) ]
...
% Calculate the derivative of specvol wrt t
